    ...
    return Scaffold(
      ...
      body: Consumer<OwnerViewModel>(
        builder: (context, vm, _) {
          ...
          final pending =
              vm.applicants.where((a) => a.status == ApplicationStatus.pending).toList();
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    ...pending.map((a) => _ApplicantCard(
                          ...
                          onApprove: () => vm.acceptApplicant(
                              widget.requirement.id, a.id),
                          onReject: () => vm.rejectApplicant(
                              widget.requirement.id, a.id),
                        )),
                  ...
                  children: [
                    Text(applicant.workerName,
                        style: const TextStyle(
                            ...
                            fontSize: 14)),
                    Text('Service Technician · ${applicant.experienceYears} yrs exp',
                        style: const TextStyle(
              ...
              children: [
                OutlinedButton(
                  ...
                  child: const Text('Reject',
                      style: TextStyle(fontSize: 11, color: Color(0xFF5A647B))),
                ),
                const SizedBox(width: 8),
                ElevatedButton(
                  onPressed: onApprove,
